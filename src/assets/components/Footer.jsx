        ...
        <div className="grid grid-cols-1 gap-10 md:gap-12 lg:grid-cols-[1.05fr_1fr_1.1fr] items-center">
          <div className="flex justify-center lg:justify-start">
            <img
              ...
              className="w-[150px] sm:w-[180px] md:w-[210px] lg:w-[250px] object-contain"
            />
          </div>

          <div className="flex flex-col items-center gap-4 text-center">
            <nav className="flex flex-wrap items-center justify-center gap-x-5 gap-y-3 text-white/70 text-sm md:text-base">
              <a href="#hero" className="transition  bg-gradient-to-r from-white to-white bg-clip-text text-transparent cursor-pointer hover:bg-linear-to-r hover:from-[#fb720994] hover:via-[#ffe600d2] hover:to-[#fb720994]">
                الرئيسية
              </a>
              <a href="#fleet" className="transition  bg-gradient-to-r from-white to-white bg-clip-text text-transparent cursor-pointer hover:bg-linear-to-r hover:from-[#fb720994] hover:via-[#ffe600d2] hover:to-[#fb720994]">
                اسطول السيارات
              </a>
              <a href="#rent" className="transition  bg-gradient-to-r from-white to-white bg-clip-text text-transparent cursor-pointer hover:bg-linear-to-r hover:from-[#fb720994] hover:via-[#ffe600d2] hover:to-[#fb720994]">
                خطوات الاستئجار
              </a>
              <a href="#about" className="transition  bg-gradient-to-r from-white to-white bg-clip-text text-transparent cursor-pointer hover:bg-linear-to-r hover:from-[#fb720994] hover:via-[#ffe600d2] hover:to-[#fb720994]">
                من نحن
              </a>
              <a href="#testimonials" className="transition  bg-gradient-to-r from-white to-white bg-clip-text text-transparent cursor-pointer hover:bg-linear-to-r hover:from-[#fb720994] hover:via-[#ffe600d2] hover:to-[#fb720994]">
                آراء العملاء
              </a>
            </nav>
          </div>
